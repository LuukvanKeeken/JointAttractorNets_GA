...
const size_t _num_source_idx = 120;
    ///// POINTERS ////////////
    ...
    int32_t _num_events = _ptr_array_ring_neurons__spikespace[_num_spikespace-1];
    ...
    if (_num_events > 0)
    {
        ...
        {
            const int _idx = _ptr_array_ring_neurons__spikespace[_j];
        ...
        if (_num_events > 0) {
            ...
            {
                const size_t _idx = _ptr_array_ring_neurons__spikespace[_j];
                const size_t _vectorisation_idx = _idx;
                                
                const int32_t _source_i = _ptr_array_ring_neurons_i[_idx];
