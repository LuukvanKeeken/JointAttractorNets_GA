...
parser.add_argument('--initial_ranges_cos', type=float, nargs=8, default=[0.0001, 1, -3, 0.0, 23, 160, 0.5, 100], help='Initial ranges for Cosine connectivity profile: g_cosine_min, g_cosine_max, w_inh_min, w_inh_max, Iff_min, Iff_max, tau_s_min, tau_s_max.')
parser.add_argument('--gene_spaces_cos', type=float, nargs=8, default=[0.0001, 1, -3, 0.0, 23, 160, 0.5, 100], help='Cosine gene spaces/limits for the optimization: g_cosine_min, g_cosine_max, w_inh_min, w_inh_max, Iff_min, Iff_max, tau_s_min, tau_s_max.')
