...
const size_t _numi = _dynamic_array_ring_synapses_asym__synaptic_pre.size();
...
const size_t _numj = _dynamic_array_ring_synapses_asym__synaptic_post.size();
...
for(int _idx=0; _idx<_N; _idx++)
{
    ...
    const int32_t i = _ptr_array_ring_synapses_asym__synaptic_pre[_idx];
    const int32_t j = _ptr_array_ring_synapses_asym__synaptic_post[_idx];
    const char _cond = i == j;
