...
parser.add_argument('--initial_ranges_cos', type=float, nargs=4, default=[0.001, 0.5, -0.7, -0.001], help='Initial ranges for Cosine connectivity profile: g_cosine_min, g_cosine_max, w_inh_min, w_inh_max.')
parser.add_argument('--gene_spaces_cos', type=float, nargs=4, default=[0.0001, 1, -3, 0.00001], help='Cosine gene spaces/limits for the optimization: g_cosine_min, g_cosine_max, w_inh_min, w_inh_max.')
