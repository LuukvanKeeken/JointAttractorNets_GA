...
void _run_ring_synapses_pre_codeobject_1()
{
    using namespace brian;


    ///// CONSTANTS ///////////
    const size_t _numI_syn_post = 120;
...
const size_t _num_postsynaptic_idx = _dynamic_array_ring_synapses__synaptic_post.size();
    ...
    {
    std::vector<int> *_spiking_synapses = ring_synapses_pre.peek();
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            double I_syn_post = _ptr_array_ring_neurons_I_syn[_postsynaptic_idx];
            const double w = _ptr_array_ring_synapses_w[_idx];
            I_syn_post += w;
            _ptr_array_ring_neurons_I_syn[_postsynaptic_idx] = I_syn_post;
...
void _debugmsg_ring_synapses_pre_codeobject_1()
{
    using namespace brian;
    std::cout << "Number of synapses: " << _dynamic_array_ring_synapses__synaptic_pre.size() << endl;
}
