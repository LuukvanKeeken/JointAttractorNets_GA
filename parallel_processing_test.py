...
# Array of 1 to 20
nums_processes = list(range(1, 3))


times = []
for num_processes in nums_processes:
    ...
    def on_generation(ga_instance):
        ...
        if not first_generation_passed:
            ...
            times.append(time.time() - first_generation_end_time)
            # Write times to a file
            with open('times.txt', 'a') as f:
                f.write(f"Processes: {num_processes}, Time: {times[-1]:.2f} seconds\n")
