...
parser.add_argument('--gene_spaces_cos', type=float, nargs=4, default=[0.0001, 1, -3, 0.00001], help='Cosine gene spaces/limits for the optimization: g_cosine_min, g_cosine_max, glob_inh (0 or 1), w_inh_min, w_inh_max.')
