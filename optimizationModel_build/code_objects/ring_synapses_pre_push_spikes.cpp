...
void _run_ring_synapses_pre_push_spikes()
{
...
const size_t _numdelay = _dynamic_array_ring_synapses_delay.size();
    ...
    {
        ring_synapses_pre.advance();
        ring_synapses_pre.push(_ptr_array_ring_neurons__spikespace, _ptr_array_ring_neurons__spikespace[_num_spikespace-1]);
    }
